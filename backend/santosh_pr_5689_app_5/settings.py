"""
Django settings for santosh_pr_5689_app_5 project.
...
ROOT_URLCONF = 'santosh_pr_5689_app_5.urls'
...
WSGI_APPLICATION = 'santosh_pr_5689_app_5.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "santosh-pr-5689-app Support <support@santosh-pr-5689-app-5.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "santosh_pr_5689_app_5 API",
    "DESCRIPTION": "API documentation for santosh_pr_5689_app_5 App",
    "VERSION": "v1",
}
